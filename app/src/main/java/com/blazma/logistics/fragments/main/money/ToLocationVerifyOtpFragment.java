...
public class ToLocationVerifyOtpFragment extends BaseFragment {
    ...
    private void initViews(){
        ...
        // Set the title
        mBinding.tvToolbarTitle.setText(R.string.verify_to_location);
    ...
    private void verifyOTP(){
        ...
        if (otp.isEmpty()) {
            ...
            LogisticsApplication.apiManager.verifyToLocationOTP(UserInfo.getInstance().selectedMoneyTask.id, otp)
                        ...
                        public void onSuccess(@NonNull VerifyLocationOtpResponse tasksResponse) {
                            ...
                            if (tasksResponse.status){
                                if (tasksResponse.data.equals(AppConstants.MSG_CORRECT_OTP)) {
                                    ...
                                    FragmentProcess.replaceFragment(mActivity.getSupportFragmentManager(), new MoneyTransferFinishFragment(), R.id.frameLayout);
                                }
                                else{
