...
public class MyPreferenceManager {
    ...
    private static final String SETTINGS_NAME = "Logistics";
     ...
     * Keys
     */
    private static final String PREF_KEY_FCM_TOKEN = "KEY_FCM_TOKEN";
    ...
    public String getFCMToken(){
        return getString(PREF_KEY_FCM_TOKEN, "test_token");
    }

    public void setFCMToken(String token){
        put(PREF_KEY_FCM_TOKEN, token);
    }
}
